...
export class ChatWidget {
  ...
  messages = signal<{ role: 'user' | 'assistant'; content: string; canEscalate?: boolean; awaitingConfirmation?: boolean }[]>([{ role: 'assistant', content: 'Hi! I’m the CTS IT assistant. Tell me about a scanner jam, connectivity problem, CBS catch-and-dispatch issue, or ask for a ticket update.' }]);
